...
|---|---|---|
|MRID (*string*)|Contract's identifier|'3fa85f64-5717-4562-b3fc-2c963f66afa6'|
...
|StartTime (*string, date-time*)|Start time of the contract, i.e. when the FSP needs to deliver the flexibility|'2024-03-12T14:45:03.516Z'|
|EndTime (*string, date-time*)|End time of the contract, i.e. when the FSP does not need to deliver the flexibility anymore|'2024-03-12T14:45:03.516Z'|
|GridNodeMRID (*string*)|identifier of the trading node for which the contract is linked|'3fa85f64-5717-4562-b3fc-2c963f66afa6'|
|ReserveObject (*string*)|Reserve object's mrid|'3fa85f64-5717-4562-b3fc-2c963f66afa6'|
|ReserveObjectLevel (*string*)|Reserve object level|enum: `'Asset'`,`'Portfolio'`|
|Direction (*string*)|Direction of the energy flow's offer|enum: `'UP'`,`'DOWN'`|
|ClearedQty (*float*)|The quantity that was cleared|1.5|
|ClearedPrice (*double*)|Cleared price|50.5|
...
|DeliveredQty (*float*)|Quantity delivered|0|
|KPI (*double*)||0|
...
|ClearedQty (*float*)|The quantity that was cleared|1.5|
|ClearedPrice (*double*)|Cleared price|50.5|
|CongestionRent (*double*)|The congestion rent|1230|
|ClearedEnergyQty (*float*)|The energy (utilisation) quantity that was cleared|12.5|
|ClearedEnergyPrice (*double*)|The price of the energy if utilised|40|
