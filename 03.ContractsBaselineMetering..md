...
|resolution (*integer* or *number*)|Resolution of the baseline in seconds||
|resource_mrid|mrid of the resource (asset or portfolio), for which the baselining is queried||
|unit (*string*)|Unit of measurement||
|values (*array: int or number*)|List of baseline values||
