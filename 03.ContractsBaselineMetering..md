...
|Field|Description|Allowable responses/examples|
|---|---|---|
|end_time (*string, date-time*)|The timestamp of the end of the last period covered by the values. ISO format YYYY-MM-DDTHH:MM:SS
The timestamp is assumed to be in naive local time unless denoted by a Z at the end of timestamp to donate the timestamp is in UTC time.
|'2024-03-12T14:45:03.516Z'|
|start_time (*string, date-time*)|The timestamp of the start of the first period covered by the values. ISO format YYYY-MM-DDTHH:MM:SS
The timestamp is assumed to be in naive local time unless denoted by a Z at the end of timestamp to donate the timestamp is in UTC time.
|'2024-03-12T14:45:03.516Z'|
...
|values (*array*)|List of metering values|[10,21,15,23,6,10]|
